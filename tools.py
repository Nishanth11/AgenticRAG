...
import asyncio
from dummy_opc_ua import get_material_availability, get_machine_states
...
if __name__ == "__main__":
    ...
    result = check_maintenance_schedule_tool.func("Product A, 2026-01-23")
    print(result)
    
    print("\nCalibration Status Check:")
    result = check_calibration_status_tool.func("Product A, 2026-01-23")
    print(result)
